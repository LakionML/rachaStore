...
$code = $_POST['code'];
$result = mysqli_query($dbc,"SELECT * FROM `products` WHERE `product_id`='$code'");
...
if(empty($_SESSION["shopping_cart"])) {
  ...
  $_SESSION['sucssess']="Product is added to your cart!";	
  //$status = "<div class='box'>Product is added to your cart!</div>";
}
else{
  $array_keys = array_keys($_SESSION["shopping_cart"]);
  if(in_array($code,$array_keys)) {
    $_SESSION['sucssess']="Product is already added to your cart!";	
...
if ($_SESSION['username']='Guest') {
  if(!empty($_SESSION["shopping_cart"])) {
    ...
    echo '<a href="AddCart.php" class="btn btn-light" ><i class="fa" style="font-size:20px">&#xf07a;</i> Cart
    <span class="badge badge-danger">0</span></a>';

    }
}
else {
 echo ' <a href="AddCart.php" class="btn btn-light btn-icon-split" ><i class="fa" style="font-size:20px">&#xf07a;</i> Cart
...
while ($rows=mysqli_fetch_assoc($prun)) 
{
  ...
  ?>
      ...
      <input type="hidden" class="qty"  value="1">
       ...
       <input type='hidden' name='code' value="<?php  echo $pid;?>" />
       <div class="row">
    <div class="col-sm-6"> <button type='submit' class="btn btn-primary btn-block" > <i class="fas fa-cart-plus">&nbsp;</i><span class='text'> Add Cart</span></button>
    </div></form>
    <div class="col-sm-6"> <a href='ProductDetails.php?product_id=<?php echo $pid ?>' class="btn btn-warning" > <i class="fas fa-cart-plus">&nbsp;</i><span class='text'> View Details</span></a>
