         ...
         if ($_SESSION['username']=='Guest')
          {
            ...
            <a class="dropdown-item" href="MyOrderDetails.php">
...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="../uploads/Site/1.jpg" class="d-block w-100" alt="...">
    </div>
...
while ($rows=mysqli_fetch_assoc($prun)) 
{
  ...
  ?>
      ...
      <input type="hidden" class="qty"  value="1">
       ...
       <div class="row">
    <div class="col-sm-6">   <button class="btn btn-primary btn-block addItemBtn"  id="AddCartbtn"><i class="fas fa-cart-plus">&nbsp;</i><span class='text'> Add Cart</span></button>
    
  </div></form> 
    <div class="col-sm-6"> <a href='ProductDetails.php?product_id=<?php echo $pid ?>' class="btn btn-warning btn-block" > <i class="fas fa-cart-plus">&nbsp;</i><span class='text'> View Details</span></a>
